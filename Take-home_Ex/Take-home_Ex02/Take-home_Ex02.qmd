...
|                                                                                                                                                                 |                                                                                                                                                                      |
| ```{=html}                                                                                                                                                      |     -   Group 1: Apartment, Condominium                                                                                                                              |
| <!-- -->                                                                                                                                                        |                                                                                                                                                                      |
...
While both Y axis in the bar-line charts are not standardised, making direct comparison less intuitive, if we standardise the values, it would compromise the visibility of bars with extremely small values e.g. Number of Units Sold: Detached House = 34 vs Apartment = 1444. As such, a compromise was made to have 2 scales for each Y axis.

For the left Y axis, 0-100 and 0-150. and for the right Y axis, 0-2M and 0-15M.
