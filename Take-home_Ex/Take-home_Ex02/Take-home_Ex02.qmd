...
```{r}
# Combine the plots
cplot1 <- hist_plot + prop_price_dist

# Set the height of the combined plot
cplot1 <- cplot1 + plot_layout(heights = c(1, 4))
...
hist_plot_apt + hist_plot_c + hist_plot_ec + hist_plot_d + hist_plot_sd + hist_plot_t +  plot_layout(ncol = 1,axis_titles = "collect") 
