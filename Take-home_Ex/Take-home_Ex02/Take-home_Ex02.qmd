...
-   Only third plot i.e. Detached House, will show Y-axis label "Number of Units" and "Median Price". It should be clear that this label applies to all plots in the composite plots
