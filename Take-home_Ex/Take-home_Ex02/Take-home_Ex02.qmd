...
prop_price_dist <- ggplot(realis_clean2, 
  ...
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10)) + labs(title = "Spread of Transacted Price per Property Type", 
       x = "Property Type", 
       y = "Transacted Price")
...
hist_plot_apt <- ggplot(data = apt_by_month, aes(x = year_month, y = total_units, fill = total_units)) +
  ...
  ) + theme(legend.position = "none", panel.background = element_rect(fill = "#CCE5FF"))
...
hist_plot_ec <- ggplot(data = ec_by_month, 
  ...
  geom_line(aes(y = avg_price *500/1600000), color = "blue") + 
   scale_y_continuous(name = "EC", 
                      limits = c(0, 500), 
                      sec.axis = sec_axis(~.*1600000/500) ) + theme(legend.position = "none", panel.background = element_rect(fill = "#CCFF99")) + labs(title = "Unit Sold & Median Price over Months")
...
hist_plot_c <- ggplot(data = c_by_month, 
  ...
  geom_line(aes(y = avg_price *1200/1800000), color = "blue") + 
   scale_y_continuous(name = "Condo", 
                      limits = c(0, 1200), 
                      sec.axis = sec_axis(~.*1800000/1200) ) +  theme(legend.position = "none", panel.background = element_rect(fill = "#99CCFF" ))
...
hist_plot_t <- ggplot(data = t_by_month, 
  ...
  geom_line(aes(y = avg_price *100/4000000), color = "blue") + 
   scale_y_continuous(name = "Terrace", 
                      limits = c(0, 100), 
                      sec.axis = sec_axis(~.*4000000/100) ) +  theme(legend.position = "none", panel.background = element_rect(fill = "#FFE5CC"))
...
hist_plot_sd <- ggplot(data = sd_by_month, 
  ...
  geom_line(aes(y = avg_price *100/7000000), color = "blue") + 
   scale_y_continuous(name = "Semi-Detached", 
                      limits = c(0, 100), 
                      sec.axis = sec_axis(~.*7000000/100, name = "Median Price") ) + theme(legend.position = "none", panel.background = element_rect(fill = "#FFCC99"))
...
hist_plot_d <- ggplot(data = d_by_month, 
  ...
  geom_line(aes(y = avg_price *50/15000000), color = "blue") + 
   scale_y_continuous(name = "Detached", 
                      limits = c(0, 100), 
                      sec.axis = sec_axis(~.*15000000/50) ) +  theme(legend.position = "none", panel.background = element_rect(fill = "#FF9933"))
