...
ggraph_plot <- ggraph(graph_data, layout = "fr") +  # Using Fruchterman-Reingold layout
  ...
  labs(title = "Directed Network Graph of Key Personnel Transactions",
       subtitle = "Nodes represent unique sources and targets, edges labeled with start year",
       caption = "Data Source: keypersonnel")  # Add titles and captions

# Convert ggraph plot to plotly object
plotly_plot <- ggplotly(ggraph_plot)
